"""
Interactive Database Setup for Hospital Supply System
...
def get_database_config():
    ...
    database = input("Database [hospital_supply_db]: ").strip() or "hospital_supply_db"
...
class InteractiveDatabaseSetup:
    def __init__(self, config):
        ...
        db_url = f"postgresql+asyncpg://{config['username']}:{quote_plus(config['password'])}@{config['host']}:{config['port']}/{config['database']}"
...
async def main():
    ...
    db_setup = InteractiveDatabaseSetup(config)
